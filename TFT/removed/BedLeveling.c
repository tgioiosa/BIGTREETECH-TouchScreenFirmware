    ...
    switch (key_num)
    {
      case KEY_ICON_0:
        ...
        #else
          {
              ...
              popupDialog(DIALOG_TYPE_ALERT, LABEL_WARNING, LABEL_CONNECT_PROBE, LABEL_CONTINUE, LABEL_CANCEL, LABEL_NULL, ablStart, NULL, NULL, NULL); //TG 3/29/23 added NULL's for 3-button popup
            #endif
          }
        #endif
        break;
      ...
      case KEY_ICON_1:
          ...
          OPEN_MENU(menuMeshEditor);
        #else
          popupDialog(DIALOG_TYPE_ALERT, LABEL_WARNING, LABEL_DISCONNECT_PROBE, LABEL_CONTINUE, LABEL_CANCEL, LABEL_NULL, deltaMeshEditor, NULL, NULL, NULL); //TG 3/29/23 added NULL's for 3-button popup
        #endif
        break;
      ...
      case KEY_ICON_5:
        if (infoMachineSettings.zProbe == ENABLED)
        {
            ...
            OPEN_MENU(menuZOffset);
          #else
            popupDialog(DIALOG_TYPE_ALERT, LABEL_WARNING, LABEL_DISCONNECT_PROBE, LABEL_CONTINUE, LABEL_CANCEL, LABEL_NULL, deltaZOffset, NULL, NULL, NULL); //TG 3/29/23 added NULL's for 3-button popup
          #endif
        }
        break;
