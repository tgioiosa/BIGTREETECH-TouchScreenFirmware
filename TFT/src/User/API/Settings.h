...
#define MAX_TOOL_COUNT        2     //TG 2/26/23 2 was 8
#define TOOL_COUNT            1     //TG 2/26/23 added same as spindle count
#define MAX_SERIAL_PORT_COUNT 4
//#define MAX_HOTEND_COUNT      6   //TG 2/26/23 removed and replaced with MAX_TOOL_COUNT
#define MAX_HEATER_COUNT      (MAX_TOOL_COUNT + 2)  // hotends + bed + chamber
#define MAX_HEATER_PID_COUNT  (MAX_TOOL_COUNT + 1)  // hotends + bed
