...
// For CNC version save flash memory by removing some unecessary features from compilation
// saves about 14 Kbytes (7%) of flash and 110 bytes RAM
#define NO_RRFSupport               // excludes all RepRap Firmware code
#define NO_UNIFIED_HEAT_MENU        // exclude UNIFIED_HEAT_MENU
#define NO_MBL                      // exclude manual bed leveling
#define NO_ABL                      // exclude auto bed leveling
#define NO_BLTOUCH                  // exclude BLTOUCH probe support
#define NO_TOUCHMII                 // exclude TOUCHMII probe support
#define NO_MESH_VALID               // exclude mesh validation
#define NO_LOAD_UNLOAD              // exclude filament load/unload functions
#define NO_PREHEAT_MENU             // exclude PREHEAT menu
#define NO_CASE_LIGHT               // exclude Case Light support
#define NO_LED_COLORS               // exclude LED colors and Events for NeoPixel
 ...
 */
#define SP_1 7  // Default: 7   //TG 2/26/23 was 6
 ...
 *             ORANGE: 8, PURPLE: 9, LIME: 10, BROWN: 11, DARKBLUE: 12, DARKGREEN: 13,    GRAY: 14, DARKGRAY: 15, MEDGRAY: 16]
 */
 ...
 */
#define HOTEND_COUNT 0  // Default: 1  LAST: #define HOTEND_NUM   0      //TG 1/9/20 to allow zero hotends     set in 1~6   was MIN_EXT_COUNT  
 ...
 *   Value range: [min: 0, max: 6]
 */
#define EXTRUDER_COUNT  1  // Default: 1  LAST: #define EXTRUDER_NUM 0      //TG 1/9/20 to allow zero extruders   set in 1~6   was MIN_EXT_COUNT
 ...
 */
#define FAN_COUNT 1  // Default: 1  LAST:  #define FAN_NUM      1      // set in 1~6
 ...
 *   Options: [disable: 0, enable: 1]
 */
#define CONTROLLER_FAN 0  // Default: 0  LAST:  #define FAN_CTRL_NUM 0      // set in 1~2
...
//TG LAST:  #define HEAT_MAX_TEMP    {275,       275,        130,      65}   //max temperature can be set   //TODO change for RPM
 ...
 */
#define MIN_TEMP 180  // Default: 180  LAST:  #define PREVENT_COLD_EXTRUSION_MINTEMP 180
...
/*TG LAST:  #define FAN_MAX_PWM      {       255,       255,       255,       255,       255,       255,       255,       255 };
*/
...
#define PREHEAT_HOTEND {210,   235,    245,   230,    220,   257}      // Default: {200,   240,    230,   170,    220,   250}
#define PREHEAT_BED    { 70,    80,    110,    50,     50,    75}      // Default: { 60,    70,     90,    50,     50,    90}
...
#define LCD_IDLE_BRIGHTNESS  4  // LCD brightness level when device is idle (Default: 5)
...
#define PID_PROCESS_TIMEOUT (15 * 90000)  // Timeout in MilliSeconds (1 minute = 60000 MilliSeconds). Default: 15 * 60000  //TG increased from 60s

// Heat
#define HEAT_SIGN_ID    {"T0:",     "T1:",     "B:",   "C:"}
#define HEAT_DISPLAY_ID {"S0",      "S1",      "Bed",  "Chamber"}
#define HEAT_SHORT_ID   {"S0",      "S1",      "Bed",  "Ch."}
#define HEAT_CMD        {"M104 T0", "M104 T1", "M140", "M141"}
#define HEAT_WAIT_CMD   {"M109 T0", "M109 T1", "M190", "M191"}
 ...
 */
#define BED_LEVELING_TYPE 1  // Default: 1  LAST:  #define ENABLE_BL_VALUE 1  // Default: 1
 ...
 */
//#define LOAD_UNLOAD_M701_M702  // Default: uncommented (enabled) //TG 10/12/22 commented out not needed, when out menuMore will have menuTriac instead of menuUnload
