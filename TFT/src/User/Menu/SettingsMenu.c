...
uint8_t Marlin_folder_name[64] = {}; //TG 5/14/23 added for enhanced info display 
...
//TG 5/14/23 added this to capture Marlin Source Code URL for info screen display
...
void menuInfo(void)
{
  ...
  const char *const msrcfile = (char *const)Marlin_folder_name;  //TG 5/14/23 added to display Marlin source folder name
  const char *const srcfile = SRC_NAME_SHORT;  //TG 5/14/23 added to display source folder name
