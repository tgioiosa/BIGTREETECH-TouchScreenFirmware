...
float fil_width_meas = 0.0;   //TG 8/12/23 holds Filament Width value from Marlin(via parseAck.c)
float fil_vol = 0.0;          //TG 8/12/23 holds Filament Volumetric Ratio from Marlin(via parseAck.c)
uint8_t msg_complete = 0;     //TG 8/27/23 for signaling that a message was responded to by Marlin
