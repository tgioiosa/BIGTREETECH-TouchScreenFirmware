...
#define NAME_LARGE_FONT           false //TG 2/25/23 added because it was used in prior version
#define VAL_LARGE_FONT            false //TG 2/25/23 added because it was used in prior version
...
//TG 3/29/23 added for a 3-button popup
#define POPUP_RECT_TRIPLE_LEFT   {75,   LCD_HEIGHT - SPACE_Y - 5 - POPUP_BUTTON_HEIGHT, 175, LCD_HEIGHT - SPACE_Y - 5}
#define POPUP_RECT_TRIPLE_MIDDLE {195,  LCD_HEIGHT - SPACE_Y - 5 - POPUP_BUTTON_HEIGHT, 295, LCD_HEIGHT - SPACE_Y - 5}
#define POPUP_RECT_TRIPLE_RIGHT  {315,  LCD_HEIGHT - SPACE_Y - 5 - POPUP_BUTTON_HEIGHT, 415, LCD_HEIGHT - SPACE_Y - 5}
