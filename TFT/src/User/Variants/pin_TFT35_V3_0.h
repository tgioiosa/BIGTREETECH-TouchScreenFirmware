...
#ifndef SERIAL_PORT
  #define SERIAL_PORT   _USART2  // default usart port (_USART2 = 1)  To Marlin TX=25 (PA_2) RX=26 (PA_3)
  #define SERIAL_PORT_2 _USART1  //                    (_USART1 = 0)  To WiFi   TX=68 (PA_9) RX=69 (PA_10)
  #define SERIAL_PORT_3 _USART3  //                    (_USART3 = 2)
  #define SERIAL_PORT_4 _UART4   //                    (_UART4  = 3)
#endif
