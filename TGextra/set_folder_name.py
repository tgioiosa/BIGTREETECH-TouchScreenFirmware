...
if len(myFolder)>60 :   #TFT display can only show 2 lines of 30 chars each
   myFolder = temp[len(temp)-3] + "/" + temp[len(temp)-2] + "/" + temp[len(temp)-1]
if len(myFolder)>60 :   #TFT display can only show 2 lines of 30 chars each
   myFolder = temp[len(temp)-2] + "/" + temp[len(temp)-1]
